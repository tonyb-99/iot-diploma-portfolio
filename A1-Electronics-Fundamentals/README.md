...
-GPIO25 in series with 150 ohm resistor and the rgb led using the 'red' pin.
-GPIO26 in series with 100 ohm resistor and the rgb led using the 'green' pin.
-GPIO27 in series with 100 ohm resistor and the rgb led using the 'blue' pin.
